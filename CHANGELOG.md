...
- Refreshed `results_blinded_adjacent_transfer_v1` frozen manifests so prereg/environment `repo_sha` values point to a resolvable repository commit again, restoring replayability of the declared code state.
