...
- AOY uplift ≥ {_pct(thresholds['aoy_uplift'])}
- Speed uplift ≥ {_pct(thresholds['speed_uplift'])}
- Repair/rework reduction ≥ {_pct(thresholds['repair_rework_reduction'])}
- Evidence completeness uplift ≥ {_pct(thresholds['evidence_completeness_uplift'])}
- No safety regression
- Package dependence rate ≥ {_pct(thresholds['package_dependence_rate'])}
...
<ul>
<li>AOY uplift: {_pct(cmp['aoy_uplift'])} (threshold ≥ {_pct(thresholds['aoy_uplift'])})</li>
<li>Speed uplift: {_pct(cmp['speed_uplift'])} (threshold ≥ {_pct(thresholds['speed_uplift'])})</li>
<li>Repair/rework reduction: {_pct(cmp['repair_rework_reduction'])} (threshold ≥ {_pct(thresholds['repair_rework_reduction'])})</li>
<li>Evidence completeness uplift: {_pct(cmp['evidence_completeness_uplift'])} (threshold ≥ {_pct(thresholds['evidence_completeness_uplift'])})</li>
<li>Safety regression: {'YES' if cmp['safety_regression'] else 'NO'} (must be NO)</li>
<li>Package dependence rate: {_pct(cmp['package_dependence_rate'])} (threshold ≥ {_pct(thresholds['package_dependence_rate'])})</li>
</ul>
